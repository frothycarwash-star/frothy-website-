...
const pages = [
  { route: '/', title: 'Frothy Carwash Lounge | Hand Car Wash in Hollywood, FL', description: 'Premium hand car wash, detailing & lounge in Hollywood, FL. No machines — just expert hands. Open 7 days, 8AM–7PM. Walk-ins welcome. Call (954) 510-3073.' },
  { route: '/services', title: 'Car Wash & Detailing Services | Frothy Hollywood FL', description: 'Hand washes from $25, full details from $65, and showroom packages up to $299. Every service done by hand. Sedan & SUV pricing. Hollywood, FL.' },
  { route: '/ceramic', title: 'Ceramic Coating Hollywood FL | Frothy Carwash Lounge', description: 'Professional ceramic coating in Hollywood, FL. 1-year, 3-year, and 5-year packages from $149. UV protection, hydrophobic finish, and enhanced gloss. Call for a free quote.' },
  { route: '/memberships', title: 'Car Wash Memberships | Frothy Hollywood FL', description: 'Monthly car wash memberships starting at $119/mo. Silver, Gold, and Platinum plans with hand washes, details, and priority scheduling. Hollywood, FL.' },
  { route: '/about', title: 'About Us | Frothy Carwash Lounge | Hollywood, FL', description: "Hollywood's premium hand car wash and lounge. Built for people who care about their car and their time. Coffee, great work, and a place worth lingering in." },
  { route: '/contact', title: 'Contact & Book | Frothy Carwash Lounge | Hollywood, FL', description: 'Book a hand wash or detailing appointment at Frothy Carwash Lounge. Call (954) 510-3073 or stop by at 2223 Pembroke Rd, Hollywood FL. Open 7 days.' },
  { route: '/gallery', title: 'Photo Gallery | Frothy Carwash Lounge | Hollywood, FL', description: 'See our work — hand washes, full details, and ceramic coatings in Hollywood, FL. Browse photos from the Frothy Carwash Lounge.' },
