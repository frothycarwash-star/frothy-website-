...
export default function CarWashDavie() {
  ...
  useSEO({
    title: 'Hand Car Wash Near Davie, FL | Frothy Carwash',
    description: 'Expert hand car wash and detailing service near Davie, FL. No machines, just careful hands.',
    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <section className="relative bg-gradient-to-r from-blue-600 to-blue-700 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl font-bold mb-6">Hand Car Wash Near Davie, FL</h1>
          <p className="text-xl text-blue-100 mb-8">Expert hand car wash and detailing service near Davie, FL. No machines, just careful hands.</p>
