    ...
    <>
      ...
      <section className="relative bg-frothy-navy pt-32 pb-16">
        <div className="absolute inset-0 opacity-10">
          <img src="/images/hand-car-wash-service-hollywood-fl.webp" alt="Hand washing a car exterior at Frothy Carwash Lounge in Hollywood, FL" className="w-full h-full object-cover" />
        </div>
