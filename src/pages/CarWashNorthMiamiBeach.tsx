...
export default function CarWashNorthMiamiBeach() {
  ...
  useSEO({
    title: 'Hand Car Wash Near North Miami Beach, FL | Frothy Carwash',
    description: 'Professional hand car wash and detailing near North Miami Beach, FL. Open 7 days, walk-ins welcome.',
    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <section className="relative bg-gradient-to-r from-blue-600 to-blue-700 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl font-bold mb-6">Hand Car Wash Near North Miami Beach, FL</h1>
          <p className="text-xl text-blue-100 mb-8">Professional hand car wash and detailing near North Miami Beach, FL. Open 7 days, walk-ins welcome.</p>
