...
export default function HeadlightRestoration() {
  ...
  useSEO({
    title: 'Headlight Restoration in Hollywood, FL | Headlight Polishing',
    description: 'Restore cloudy, oxidized headlights to like-new clarity. Affordable alternative to replacement.',
    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <section className="relative bg-gradient-to-r from-blue-600 to-blue-700 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">Restore cloudy, oxidized headlights to like-new clarity. Affordable alternative to replacement.</p>
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Professional headlight restoration</h2>
          <p className="text-gray-700 leading-relaxed">At Frothy Carwash Lounge, we offer premium headlight restoration designed to protect your vehicle and enhance its appearance. Our expert technicians use industry-leading techniques and products to deliver results that last.</p>
        </section>
        ...
        <section className="bg-blue-50 p-8 rounded-lg mb-12 text-center">
          ...
          <button onClick={() => setBookingOpen(true)} className="bg-blue-600 text-white px-8 py-3 rounded-lg font-bold hover:bg-blue-700 inline-flex items-center gap-2">
            Book headlight Now <ArrowRight className="w-4 h-4" />
          </button>
        </section>
